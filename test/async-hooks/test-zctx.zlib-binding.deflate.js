...
const as = hooks.activitiesOfTypes('ZCTX');
assert.strictEqual(as.length, 1, 'one zctx on when created handle');
const hdl = as[0];
assert.strictEqual(hdl.type, 'ZCTX', 'zctx');
